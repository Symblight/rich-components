 ...
 * i.e. not nested inside another component's shadow root — see
 * .claude/plans/attachments.spec.md's "Drop target ownership" for the live
 * finding that motivated this constraint.
